...
SITE_URL = "https://nicoguaro.github.io/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/pages/about/", "About"),
        ("/index.html", "Blog"),
        ("/pages/preprints-archive/", "Preprints"),
        ("/pages/links/", "Links"),
...
# is in the manual.
COMMENT_SYSTEM_ID = "nicoguaro-github"
...
### Google analytics
#
# Check: https://developers.google.com/analytics/devguides/collection/analyticsjs/
BODY_END = """
<script>
